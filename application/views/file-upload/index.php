<head>
    ...
    <![endif]-->
    <meta charset="utf-8">
    <title>TomTop-Files-Service</title>
    <!-- Bootstrap styles -->
...
<div class="container">
    ...
    <form id="fileupload" data-url="/file/upload/index" action="/file/upload/index" method="POST" enctype="multipart/form-data">
...
<script>
    ...
    $('#fileupload').fileupload('option',{
        acceptFileTypes: /(\.|\/)(apk|doc|zip|png|jpe?g|gif|webp)$/i,
        messages:{
